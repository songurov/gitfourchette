...
class Ui_CommitDialog(object):
    def setupUi(self, CommitDialog):
        ...
        self.summaryComboBox = QComboBox(parent=CommitDialog)
        self.summaryComboBox.setEditable(True)
        self.summaryComboBox.setInsertPolicy(QComboBox.InsertPolicy.NoInsert)
        self.summaryComboBox.setObjectName("summaryComboBox")
        self.summaryRowLayout.addWidget(self.summaryComboBox)
        ...
        CommitDialog.setTabOrder(self.summaryComboBox, self.descriptionEditor)

    def retranslateUi(self, CommitDialog):
        CommitDialog.setWindowTitle(_p("CommitDialog", "Commit"))
        self.summaryComboBox.setPlaceholderText(_p("CommitDialog", "Enter commit summary"))
